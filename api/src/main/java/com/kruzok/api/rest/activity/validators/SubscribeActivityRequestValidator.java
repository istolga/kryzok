...
@Component
public class SubscribeActivityRequestValidator implements
		IValidator<SubscribeActivityRequest> {
	...
	@Override
	public void validate(SubscribeActivityRequest request) throws Exception {
